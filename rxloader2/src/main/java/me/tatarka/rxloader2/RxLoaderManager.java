...
public class RxLoaderManager {
    ...
    /**
     * Creates a new {@link me.tatarka.rxloader2.RxLoader} that manages the given {@link
     * io.reactivex.Observable}. This should be called in {@link android.app.Activity#onCreate(android.os.Bundle)}
     * or similar.
     *
    ...
    /**
     * Creates a new {@link me.tatarka.rxloader2.RxLoader} that manages the given {@link
     * io.reactivex.Observable}. It uses the {@link me.tatarka.rxloader2.RxLoaderManager#DEFAULT} tag. This
    ...
    /**
     * Creates a new {@link me.tatarka.rxloader2.RxLoader1} that manages the given {@link
     * io.reactivex.Observable}. This should be called in {@link android.app.Activity#onCreate(android.os.Bundle)}
     * or similar.
     *
     * @param tag            The loader's tag. This must be unique across all loaders for a given
    ...
    /**
     * Returns if the {@code RxLoaderManager} contains a {@link me.tatarka.rxloader2.RxLoader} with
     * the given tag.
     *
